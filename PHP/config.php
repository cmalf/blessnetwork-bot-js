...
$accounts = [
    [
        'AUTH_TOKEN' => 'xxxxx', // Bearer token for Account 1
    ],
    // [
    //     'AUTH_TOKEN' => '', // Bearer token for Account 2
    // ],
...
function getRandomUserAgent() {
    ...
    $index = mt_rand(0, count($USER_AGENTS) - 1);
    return $USER_AGENTS[$index];
}

$proxyFile = 'proxy.txt'; // Path to your proxy.txt file
